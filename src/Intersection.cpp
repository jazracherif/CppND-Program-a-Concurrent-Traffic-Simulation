...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if (!trafficLightIsGreen()){
        lck.lock();
        std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << ": TrafficLight #" << _trafficLight.getID() << ": wait for Green" << std::endl;
        lck.unlock();

        _trafficLight.waitForGreen();
    }
    lck.lock();
    std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << ": TrafficLight #" << _trafficLight.getID() << ": green" << std::endl;
    lck.unlock();
